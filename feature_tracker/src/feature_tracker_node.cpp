...
FeatureTracker trackerData[NUM_OF_CAM];// 图像的追踪信息，包括prev、cur、forw帧的特征以及特征的移动速度等
...
void img_callback(const sensor_msgs::ImageConstPtr &img_msg)
{
     ...
     */
    // 这里通过控制pub_count / (img_msg->header.stamp.toSec() - first_image_time))这个量，其中分子代表已发布的次数，分母则为当前帧与初始帧的时间差，
